    ...
    <>
      <section className="min-h-screen flex items-stretch text-white ">
        <div
          ...
          style={{
            backgroundImage: `url(https://images.unsplash.com/photo-1556740714-a8395b3bf30f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)`,
          }}
        >
          ...
          <div className="w-full py-6 z-20 flex flex-col  items-center">
            ...
            >
              ...
              <Input
                ...
                value={password}
                placeholder={
                  err.password ?? `Password ${type === "register" ? "*" : ""}`
                }
              />
              {type === "register" ? (
                <Input
              ...
              <div
                ...
                className="text-right text-sm text-base-content w-full mt-3"
              >
                {type === "register"
